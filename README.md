...
| **LVLX** | NFT platform on BNB Smart Chain — collaborated within a development team on ERC-1155 NFT contracts with a referral system and token staking. | `Solidity` `ERC-1155` `Hardhat` |
| **Dgallery** | UUPS-upgradeable NFT marketplace with on-chain dividends distribution, deployed and verified on BNB Smart Chain — built collaboratively within a development team. | `Solidity` `Hardhat` `OpenZeppelin` `NFT Marketplace` |
